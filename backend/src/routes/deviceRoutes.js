...
import { withDevicePhoto } from '../middleware/upload.js';
...
router.post('/:id/photo', requireRole('admin', 'koordinator', 'teknisi'), withDevicePhoto, uploadDevicePhoto);
router.delete('/:id/photo', requireRole('admin', 'koordinator', 'teknisi'), removeDevicePhoto);
