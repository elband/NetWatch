...
export const NAV_ITEMS: Record<Role, NavEntry[]> = {
  ...
  teknisi: [
    { section: 'Saya' }, { id: 'my-dashboard', icon: '📊', label: 'Dashboard Saya' },
  ...
  viewer: [
    { section: 'Monitoring' }, { id: 'dashboard', icon: '📊', label: 'Dashboard' }, { id: 'devices', icon: '🖥️', label: 'Perangkat' }, { id: 'monitor', icon: '📡', label: 'Live Monitor' },
  ],
};

export const PAGE_TITLES: Record<string, string> = {
  dashboard: 'Dashboard', devices: 'Manajemen Perangkat', monitor: 'Live Monitor',
  incidents: 'Manajemen Insiden', reports: 'Laporan Selesai', jadwal: 'Jadwal Dinas',
  users: 'Manajemen User', wa: 'Log WhatsApp', settings: 'Pengaturan',
