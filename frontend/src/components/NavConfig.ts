...
export const NAV_ITEMS: Record<Role, NavEntry[]> = {
  ...
  koordinator: [
    ...
    { section: 'Administrasi' }, { id: 'users', icon: '👥', label: 'Manajemen User' }, { id: 'master', icon: '🗂️', label: 'Master Data' }, { id: 'surat', icon: '📤', label: 'Surat Keluar' }, { id: 'laporan-bulanan', icon: '🗓️', label: 'Laporan Bulanan' }, { id: 'laporan-aab', icon: '🚜', label: 'Laporan Bulanan AAB' }, { id: 'skp', icon: '📋', label: 'SKP / e-Kinerja' }, { id: 'attendance', icon: '🕒', label: 'Absensi' }, { id: 'diklat', icon: '🎓', label: 'Pengajuan Diklat' }, { id: 'kegiatan-nr', icon: '📝', label: 'Kegiatan Non-Rutin' }, { id: 'dokumen', icon: '📚', label: 'Manajemen Dokumen' },
